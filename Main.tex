...
\begin{titlepage}
    ...
    \begin{figure}[H]
    	\centering
    	\includegraphics[scale=1]{logo_if}
    \end{figure}

	{
	\large Instituto Federal de Minas Gerais \\
...
% ========== Title ===============	
	...
	{	\Huge Introdução à Forense Digital\\
...
% ========= Autores ==============
	...
	{\large Rafael Alvarenga de Azevedo e \\
...
% ========= Revisores =============
    ...
    Texto revisado por Prof. João Bosco de Castro.
...
\input{textos/Cap7}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{textos/ConsideracoesFinais}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
